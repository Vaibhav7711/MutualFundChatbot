...
def ask_question(collection, query, scheme):
    ...
    # FIX 1: Removed stray `return False` that was on same line as this return
    return handle_llm(collection, query, scheme)

def list_available_embeddings_models():
...
if __name__ == "__main__":
    print("=" * 50)
    print("MUTUAL FUND RAG SYSTEM - STARTUP")
    print("=" * 50)

    # FIX 2: Removed test_api_connection() call — function was never defined
    ...
    try:
        ...
        print(f"\n✓ System ready. Collection has {collection.count()} chunks")
    except Exception as e:
        print(f"\n❌ Fatal error: {e}")
        raise